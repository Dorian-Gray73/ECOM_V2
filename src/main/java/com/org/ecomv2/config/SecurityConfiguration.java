package com.org.ecomv2.config;

import com.org.ecomv2.security.*;
import com.org.ecomv2.security.jwt.*;
...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
            ...
            .antMatchers("/api/transactions/encours").permitAll()
            .antMatchers("/api/transactions/user/{idUtilisateur}").authenticated()
            ...
            .antMatchers("/api/caracteristiques/quantite/{id}/{quantite").permitAll()
